...
public interface RunDao extends MarquezDao {
  ...
  @SqlQuery(
      SELECT_RUN
          + " WHERE r.job_name = :jobName AND r.namespace_name = :namespaceName ORDER by created_at DESC LIMIT 2")
  List<ExtendedRunRow> findLast2Runs(String jobName, String namespaceName);
